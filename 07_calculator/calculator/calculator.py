...
class Calculator:
    ...
    def input_entry(self):
        self.entry_input = tk.Entry(self.window, text="Input label")
        self.entry_input.grid(row=1, column=0, columnspan=3)

    def add_sym_to_input(self, symbol_to_add):
        self.entry_input.insert(tk.END, symbol_to_add)

    def calculate_and_display_result(self):
        result = eval(self.entry_input.get())
